...
public final class jar extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "error.bad.dflag", "'-d, --print-module-descriptor' option requires no input file(s) to be specified: {0}" },
            ...
            { "main.help.opt.main.print-module-descriptor", "  -d, --print-module-descriptor  Print the module descriptor" },
