...
public class VersionInfo {
     ...
     * Build Timestamp.
     */
    private static final String BUILD_TIMESTAMP = "2017-03-04-100207";

    /**
     * Hudson Job Name.
     */
    private static final String HUDSON_JOB_NAME = "9";

    /**
     * Hudson Build Number.
     */
    private static final String HUDSON_BUILD_NUMBER = "86";

    /**
     * Promoted build number used as part of the runtime version string.
     */
    private static final String PROMOTED_BUILD_NUMBER = "160";

    /**
     * Raw Version number string. (without milestone tag)
     */
    private static final String RELEASE_VERSION = "9";
