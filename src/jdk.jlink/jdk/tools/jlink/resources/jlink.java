...
public final class jlink extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.usage", "Usage: {0} <options> --module-path <modulepath> --add-modules <mods> --output\n<path> Possible options include:" },
            { "main.usage.summary", "Usage: {0} <options> --module-path <modulepath> --add-modules <mods> --output\n<path> use --help for a list of possible options" },
